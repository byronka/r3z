...
import r3z.authentication.types.UserName
...
import r3z.timerecording.types.MAX_DETAILS_LENGTH
import r3z.timerecording.types.Time
...
class TimeEntryUIValidationTests {
    ...
    /**
     * The description can be up to [r3z.timerecording.types.MAX_DETAILS_LENGTH]
