...
import r3z.bddframework.UserStory
...
object TimeEntryUserStory : UserStory(
   ...
   So that I can work with my time entries without really having to think about the tool
    ...
    init {
        ...
        addScenario(
            "An employee has entered time for a period, and their approver wants to approve it",

            "Given an employee has entered 8 hours for the entire time period",
            "When the approver views the period",
            "Then they are able to approve it"
        )
